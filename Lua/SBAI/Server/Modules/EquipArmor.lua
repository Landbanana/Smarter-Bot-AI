...
local function activate(self)
    ...
    do
        ...
        ---@param slotTypeCheck fun(slot:Barotrauma.InvSlotType):boolean
        ---@param character Barotrauma.Character
        ---@param item Barotrauma.Item
        ---@return boolean
        function wearableArmorPredicate(slotTypeCheck, character, item)
            return item.GetComponent(Wearable) ~= nil and
                ...
                Any(item.AllowedSlots, slotTypeCheck)
        end
    end
    ...
    do
        ...
        function(instance, ptable)
            ...
            then
                ...
                local wearables = FindItems(character, inventory.GetAllItems(true), nil, nil, Partial1(wearableArmorPredicate,
                function(slot)
